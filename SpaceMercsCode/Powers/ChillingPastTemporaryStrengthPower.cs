...
public class ChillingPastTemporaryStrengthPower() : TemporaryStrengthPower, ICustomPower
{
    public override AbstractModel OriginModel => ModelDb.Card<ChillingPast>();
